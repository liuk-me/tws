...
<div id="footer">
  <p><i class="fa fa-copyright"></i> <?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a> Powered by <a href="http://typecho.org" target="_blank">Typecho</a> & <a href="https://cwlog.net" target="_blank">TWS</a></p>
